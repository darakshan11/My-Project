                    ...
                    <div class="container-fulid">
                        <div class="row bg-dark text-light">
                            <div class="col-sm-10" align="center">
                                <h3 class="my-2"><cite>Add Notification Here</cite></h3>
                            </div>
                        ...
                        <div class="row">
                            <form action="notification_code.php" method="post">
                                <textarea class="form-control text-center mt-5" type="text" placeholder="Add your notification...." name="notification"></textarea>
